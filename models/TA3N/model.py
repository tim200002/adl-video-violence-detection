...
class VideoModel(nn.Module):
	def __init__(self, num_class, modality, feature_dim,
	...
	def _prepare_DA(self, num_class): # convert the model to DA framework
		...
		if self.frame_aggregation == 'trn': # 4. TRN (ECCV 2018) ==> fix segment # for both train/val
			...
			raise ValueError('Unknown frame aggregation method: {}'.format(self.frame_aggregation))
